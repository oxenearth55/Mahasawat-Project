...
<div class="modal fade" id="wai" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <h3 class="font-weight-bold text-center white-text pb-2">ฟาร์มกล้วยไม้คุณสร้อย</h3>
  <hr class="w-header my-4"/>
  <p class="lead text-center text-muted white-text pt-2 mb-5">สินค้าตัวอย่างจากทางฟาร์มกล้วยไม้คุณสร้อย</p>
